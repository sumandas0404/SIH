...
const SignupForm = ({setIsLoggedIn}) => {
  ...
  return (
    <div>
        ...
        <div
        className='flex bg-[#d1dbea] p-2 gap-x-4 my-6 rounded-full max-w-max'>

            <button
            className={`${accountType === "tutor" 
            ?
              "bg-[#64CCC5] text-black font-semibold"
            :"bg-[#00336E] text-white"} py-2 px-5 rounded-full transition-all duration-200`}
            onClick={()=> setAccountType("tutor")}>
                Tutor
            </button>

            <button
            className={`${accountType === "NGO" 
            ?
              "bg-[#64CCC5] text-black font-semibold"
            :"bg-[#00336E] text-white"} py-2 px-5 rounded-full transition-all duration-200`}
            ...
            <button
            className={`${accountType === "schools" 
            ?
              "bg-[#64CCC5] text-black font-semibold"
            :"bg-[#00336E] text-white"} py-2 px-5 rounded-full transition-all duration-200`}
            onClick={() => setAccountType("schools")}>
                Schools
            </button>
        </div>
            ...
            <div className='flex gap-x-4 mt-[20px]'>
                    <label className='w-full'>
                        ...
                        <input
                            ...
                            className='bg-[#00336E] rounded-[0.5rem] text-richblack-900 w-full p-[12px]'
                        />
                    </label>
